...
from train import train_vgan2_non_pop
...
if __name__ == '__main__':
    ...
    print('=' * 50, '开始训练模型', '=' * 50)
    train_vgan2_non_pop(vgan_train_parameter, epoches=epoch, batch_size=batch_size, nb_zr=128, nb_pm=128,
