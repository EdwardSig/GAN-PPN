...
from train import train_vgan2_non_pop_non_positive_pref
...
if __name__ == '__main__':
    train_file = '../data/douban-book/preprocessing/douban-book-train.csv'
    test_file = '../data/douban-book/preprocessing/douban-book-test_filter.csv'
    sep = ','
    ...
    print('=' * 50, '开始训练模型', '=' * 50)
    train_vgan2_non_pop_non_positive_pref(vgan_train_parameter, epoches=epoch, batch_size=batch_size, nb_zr=128, nb_pm=128,
